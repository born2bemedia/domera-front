    ...
    if (SENDGRID_API_KEY && FROM_EMAIL && normalizedEmail) {
      try {
        ...
        const welcomeEmailHtml = createBrandedEmailHtml({
          previewTitle: 'Welcome to Domera',
          title: `Welcome to Domera, ${safeFirstName}!`,
          bodyHtml: [
            renderEmailParagraph(
              'Congratulations. Your account has been created successfully, and you can now start exploring Domera.'
            ),
        ...
        const welcomeMsg = {
          to: normalizedEmail,
          from: FROM_EMAIL,
          subject: 'Welcome to Domera - Your Account is Ready',
